...
def generate_data(size_MiB=10):
    ...
    reviews = generate_reviews(6000 * size_MiB, [user[0] for user in users], [product[0] for product in products])
    ...
    save_to_csv('data/products.csv', products, ['product_id', 'name', 'category', 'price', 'stock'])
    save_to_csv('data/orders.csv', orders, ['order_id', 'user_id', 'order_date', 'total_amount'])
    save_to_csv('data/order_items.csv', order_items, ['order_id', 'product_id', 'quantity', 'price'])
    save_to_csv('data/reviews.csv', reviews, ['review_id', 'user_id', 'product_id', 'rating', 'comment'])
